...
//   @override
//   State<RegisterParent> createState() => _RegisterUserState();
// }
//
// class _RegisterUserState extends State<RegisterParent> {
//   bool isPasswordShown = true;
//
//   final _formKey = GlobalKey<FormState>();
//
...
//     //   context: context, builder: (context) => CircularProgressIndicator(color: kColorRed,),);
//     progressIndicator(context);
//     print(_formData["email"]);
//     print(_formData["password"]);
//   }
